				...
				types: [
					{
						name: "McpServerView",
						declaration:
							"export interface McpServerView { id: string; serverName: string; transport: 'stdio' | 'streamable-http'; command?: string; args?: string[]; env?: Record<string, string>; cwd?: string; url?: string; headers?: Record<string, string>; toolCallTimeoutMs?: number; failOnStartupError?: boolean; enabled: boolean; phase: string | null; }",
					},
					{
						name: "McpServerInput",
						declaration:
							"export type McpServerInput = { id: string; serverName: string; transport: 'stdio'; command: string; args?: string[]; env?: Record<string, string>; cwd?: string; enabled: boolean; toolCallTimeoutMs?: number; failOnStartupError?: boolean; } | { id: string; serverName: string; transport: 'streamable-http'; url: string; headers?: Record<string, string>; enabled: boolean; toolCallTimeoutMs?: number; failOnStartupError?: boolean; };",
					},
					{
						name: "SaveInput",
